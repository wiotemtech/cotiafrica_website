    ...
    <div class="container relative z-10 mx-auto px-4">
      <div class="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-end">
        <div class="lg:col-span-8">
          ...
          <p class="mt-6 max-w-3xl text-lg text-slate-200 md:text-xl">CodeToInnovate Africa combines software engineering, digital capacity building, and compliance-led execution to help institutions and communities move from intention to measurable impact.</p>
        </div>
  ...
  <section class="py-20">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
        <article class="c2i-surface-soft rounded-2xl p-8 md:p-10">
        ...
        <article class="c2i-surface rounded-2xl p-8 md:p-10">
