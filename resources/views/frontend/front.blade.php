...
<div class="program-section">
  ...
  <section  class="admission-requirements-section">
    ...
    <div class="erc-container">
        <!-- Outcome 1 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Train to Become a Frontend Developer</h3>
            <p class="erc-card-text">Master essential frontend technologies like HTML, CSS, JavaScript, and frameworks like React and Angular. Build real-world projects and develop the expertise needed to create interactive and user-friendly web applications.</p>
        </div>

        <!-- Outcome 2 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Showcase Your Expertise</h3>
            <p class="erc-card-text">Create impressive portfolio projects that highlight your skills, including building responsive websites, crafting engaging user interfaces, and optimizing user experiences. Employers will recognize your capabilities instantly.</p>
        </div>

        <!-- Outcome 3 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Receive Your Diploma Certificate</h3>
            <p class="erc-card-text">Successfully completing the program will earn you a distinguished diploma, recognizing your expertise and dedication to mastering Frontend Engineering.</p>
        </div>

        <!-- Outcome 4 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Unlock High-Demand Career Opportunities</h3>
            <p class="erc-card-text">Your newly acquired skills will open doors to exciting frontend engineering roles in leading tech companies. Whether at innovative startups or major enterprises, frontend developers are in high demand like never before.</p>
        </div>
    </div>
