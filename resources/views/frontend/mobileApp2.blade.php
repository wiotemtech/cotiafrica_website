...
<div class="section">
    <h1 style="font-size: 5vw;color:white;font-family:'poppins',sans-serif" >MobileApp Dev</h1>
...
<div class="program-section">
  ...
  <section  class="admission-requirements-section">
    ...
    <div class="erc-container">
        <!-- Outcome 1 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Train to Become a Mobile App Developer</h3>
            <p class="erc-card-text">Master essential mobile app technologies like React Native, Flutter, Java, and databases. Build real-world projects and develop the expertise needed to solve complex challenges in the mobile app industry.</p>
        </div>

        <!-- Outcome 2 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Showcase Your Expertise</h3>
            <p class="erc-card-text">Create impressive portfolio projects that highlight your skills, including building mobile apps, integrating third-party APIs, and optimizing performance. Employers will recognize your capabilities instantly.</p>
        </div>

        <!-- Outcome 3 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Receive Your Diploma Certificate</h3>
            <p class="erc-card-text">Successfully completing the program will earn you a distinguished diploma, recognizing your expertise and dedication to mastering Mobile App Development.</p>
        </div>

        <!-- Outcome 4 -->
        <div class="erc-card">
            <h3 class="erc-card-title">Unlock High-Demand Career Opportunities</h3>
            <p class="erc-card-text">Your newly acquired skills will open doors to exciting mobile app development roles in leading tech companies. Whether at innovative startups or major enterprises, mobile app developers are in high demand like never before.</p>
        </div>
    </div>
